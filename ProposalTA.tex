...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN SISTEM KONTROL AKSES BERBASIS PENGENALAN WAJAH UNTUK MANAJEMEN TAMU PADA BANGUNAN CERDAS}\\
     \vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Natanael Steven Simangunsong }\\
    {\large 18222054}
    }\\
