...
KNF-1 (Akurasi) &
Pengujian dilakukan dengan 20 sampel pengguna (10 terdaftar dan 10 tidak terdaftar) untuk menghitung jumlah prediksi benar (\textit{true positive + true negative}) dan prediksi salah (\textit{false positive + false negative}). &
