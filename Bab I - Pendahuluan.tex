...
Teknologi pengenalan wajah menawarkan keunggulan berupa otomatisasi, peningkatan keamanan, pengurangan interaksi fisik, dan kecepatan verifikasi pengguna.
...
\begin{enumerate}
\item	Bagaimana merancang sistem kontrol akses berbasis pengenalan wajah untuk manajemen tamu pada Gedung ITB Innovation Park?
\item   Bagaimana mengembangkan mekanisme pendaftaran mandiri berbasis web dan sinkronisasi data wajah untuk mmendukung alur masuk tamu?
\end{enumerate}

% --- Tujuan ---
\section{Tujuan}
Tujuan dari tugas akhir ini adalah mengembangkan sistem kontrol akses berbasis pengenalan wajah untuk mendukung pengelolaan tamu pada gedung IIP.
...
\item   Mengembangkan sistem pendaftaran mandiri yang memungkinkan tamu untuk mendaftarkan data identitas dan wajahnya sebelum melakukan kunjungan.
\end{enumerate}

Tugas akhir ini dinyatakan berhasil apabila memenuhi kriteria berikut:
\begin{enumerate}
\item   Sistem mampu melakukan proses autentikasi wajah tamu dan memberikan sinyal buka ke gerbang dengan waktu respons yang cepat untuk meminimalisir antrian.
\item   Sistem pendaftaran mandiri dapat diakses dengan mudah oleh tamu dan mampu menyimpan data identitas serta wajah secara aman.
\item   Sistem mampu secara konsisten membedakan antara tamu yang terdaftar dan yang tidak terdaftar.
\end{enumerate}
% --- Batasan Masalah ---
